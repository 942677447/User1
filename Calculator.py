...
class Calc(QWidget):
    def __init__(self) -> None:
        ...
        self.setStyleSheet('background : #DDE6ED')
        self.initUI()
        self.show()
    ...
    def initUI(self):
        ...
        self.label_display.setAlignment(Qt.AlignRight)

        self.edit_display = QLineEdit()
        self.edit_display.setPlaceholderText('0')
        # self.edit_display.setFixedHeight(50)
        self.edit_display.setStyleSheet('background : white;' 'border :2px solid #18122B;' 'font-size: 25pt;')
